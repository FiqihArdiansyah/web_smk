...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT tbl_siswa.*,  tbl_jurusan.jurusan FROM tbl_siswa LEFT JOIN tbl_jurusan on tbl_siswa.id_jurusan = tbl_jurusan.id  WHERE tbl_siswa.id = $id");
...
<head>
	...
	<title>Detail Siswa - SMK AL-ITTIHAD RAAS</title>
