...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_siswa (nama, nis, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat, no_hp, foto,id_jurusan , id_kelas) VALUES('$nama', $nis, '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_hp', '$nama_foto', '$id_jurusan', '$id_kelas')") or die(mysqli_error($koneksi));
