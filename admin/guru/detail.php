...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT tbl_guru.id,tbl_guru.nama,tbl_guru.nip ,tbl_guru.jenis_kelamin,tbl_guru.tempat_lahir,tbl_guru.tanggal_lahir,tbl_guru.alamat,tbl_guru.foto,tbl_guru.no_hp, tbl_guru.id_mapel, tbl_mapel.mapel,tbl_mapel.id AS id_mapel FROM tbl_guru LEFT JOIN tbl_mapel on tbl_guru.id_mapel = tbl_mapel.id  WHERE tbl_guru.id = $id");
