...
$query = mysqli_query($koneksi, "SELECT tbl_guru.id AS id, tbl_guru.nama ,tbl_guru.alamat,tbl_guru.foto,tbl_guru.no_hp, tbl_guru.id_mapel, tbl_mapel.mapel,tbl_mapel.id AS id_mapel FROM tbl_guru LEFT JOIN tbl_mapel on tbl_guru.id_mapel = tbl_mapel.id  ORDER BY id ASC");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Data Guru - SMK AL-ITTIHAD RAAS</title>
