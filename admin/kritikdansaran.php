...
<head>
	...
	<title>Data Bukutamu - SMK AL-ITTIHAD RAAS</title>
						    ...
						    <tbody>
						        <?php while($row = mysqli_fetch_assoc($query)) : ?>
						        	<tr>
						        		...
						        		<td><?= $row['isi'] ?></td>
						        		<td>
						        			<a href="hapus_kritik.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')">Hapus</a>
						        		</td>
						        	</tr>
						        <?php endwhile; ?>
						    </tbody>
