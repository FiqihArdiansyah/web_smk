  ...
  width: 30px;"></img>
	...
	<div class="navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="<?= $base_url ?>admin/mapel/index.php">Data Mata Pelajaran</a>
					...
					<a class="dropdown-item" href="<?= $base_url ?>admin/ekskul/index.php">Data Ekstrakurikuler</a>
			...
			<li class="nav-item">
				<a class="nav-link <?= $active == 'bukutamu' ? 'active' : '' ?> " href="<?= $base_url ?>admin/kritikdansaran.php">Kritik Dan Saran</a>
			</li>
			<li class="nav-item">
