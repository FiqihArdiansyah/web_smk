...
$query = mysqli_query($koneksi, "SELECT tbl_mapel.id AS id, tbl_mapel.kode_mapel ,tbl_mapel.mapel, tbl_mapel.id_jurusan, tbl_jurusan.jurusan,tbl_jurusan.id AS id_jurus FROM tbl_mapel LEFT JOIN tbl_jurusan on tbl_mapel.id_jurusan = tbl_jurusan.id  ORDER BY id ASC");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Data MAPEL - SMK AL-ITTIHAD RAAS</title>
