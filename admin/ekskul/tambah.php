...
<head>
	...
	<title>Tambah Ekskul - SMK AL-ITTIHAD RAAS</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="ketua" placeholder="ketua ekskul" autocomplete="off" required="required" name="ketua">
							</div>
							<div class="form-group">
										<label for="tanggal">Tanggal Berdiri</label>
										<input type="date" class="form-control" id="tanggal" placeholder="tanggal" autocomplete="off" required="required" name="tanggal">
									</div>
							<div class="form-group">
