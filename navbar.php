...
<nav class="navbar navbar-expand-lg nav-orange">
	<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
		<img src="resources/images/menu.svg" style="color: white; 
  height: 30px;
  width: 30px;"></img>
	</button>
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		<div class="navbar-nav">
			...
			<a class="nav-item nav-link text-white navlink <?= $aktif == 'mapel' ? 'active' : '' ?>" href="mapel.php">MATA PELAJARAN</a>
			...
			<a class="nav-item nav-link text-white navlink <?= $aktif == 'kelas' ? 'active' : '' ?>" href="kelas.php">KELAS</a>
			...
			<a class="nav-item nav-link text-white navlink <?= $aktif == 'bukutamu' ? 'active' : '' ?>" href="kritikdansaran.php">KRITIK DAN SARAN</a>
			<a class="nav-item nav-link text-white navlink <?= $aktif == 'tentang_website' ? 'active' : '' ?>" href="tentang_smk.php">TENTANG SEKOLAH</a>
		</div>
	</div>
</nav>