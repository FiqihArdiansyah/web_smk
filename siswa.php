...
$query = mysqli_query($koneksi, "SELECT tbl_siswa.id, tbl_siswa.nama, tbl_siswa.no_hp, tbl_siswa.foto, tbl_siswa.nis, tbl_jurusan.jurusan AS jurusan FROM tbl_siswa LEFT JOIN tbl_jurusan ON tbl_siswa.id_jurusan = tbl_jurusan.id");
$aktif = 'siswa';
$no = 1;
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Daftar Siswa - SMK AL-ITTIHAD RAAS</title>
